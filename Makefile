...
$(EXEC):
	...
	nvcc -G -g -O0 -Xptxas -O0 -arch=sm_75 --resource-usage -I include -lcuda main.cu -o mock
	#nvcc -O3 -Xptxas -O3 -arch=sm_75 --resource-usage -I include -lcuda main.cu -o mock
    
	nvcc -G -g -O0 -Xptxas -O0 -arch=sm_75 --resource-usage --maxrregcount 24 -Xptxas -warn-lmem-usage -Xptxas --warn-on-spills -I include -lcuda \
